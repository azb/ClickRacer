...
TweenPlayOnceDelay(tween_xscale, xscale__, image_xscale, 0, argument0, EaseInCubic,argument1);
TweenPlayOnceDelay(tween_yscale, yscale__, image_yscale, 0, argument0, EaseInCubic,argument1);
